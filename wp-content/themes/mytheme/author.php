		...
		<section id="primary">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'mytheme' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
				</header>
				...
				<div id="author-info">
					<div id="author-avatar">
						 ...
						 */
						echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'mytheme_author_bio_avatar_size', 60 ) );
						?>
					</div><!-- #author-avatar -->
