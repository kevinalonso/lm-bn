 ...
 *
 * To override mytheme_setup() in a child theme, add your own mytheme_setup to your child theme's
 * functions.php file.
 *
...
function mytheme_setup() {
	 ...
	 * a find and replace to change 'mytheme' to the name
	...
	$custom_header_support = array(
		 ...
		 */
		'width' => apply_filters( 'mytheme_header_image_width', 1000 ),
		/**
		 ...
		 */
		'height' => apply_filters( 'mytheme_header_image_height', 288 ),
...
function mytheme_header_style() {
	...
	?>
	<style type="text/css" id="mytheme-header-css">
	<?php
 ...
 *
 * Referenced via add_theme_support('custom-header') in mytheme_setup().
 *
 * @since Twenty Eleven 1.0
 */
function mytheme_admin_header_style() {
?>
	<style type="text/css" id="mytheme-admin-header-css">
...
if ( ! function_exists( 'mytheme_continue_reading_link' ) ) :
/**
...
endif; // mytheme_continue_reading_link
...
function mytheme_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Showcase Sidebar', 'mytheme' ),
		'id' => 'sidebar-2',
		'description' => __( 'The sidebar for the optional Showcase Template', 'mytheme' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Footer Area One', 'mytheme' ),
		'id' => 'sidebar-3',
	...
	register_sidebar( array(
		'name' => __( 'Footer Area Two', 'mytheme' ),
		'id' => 'sidebar-4',
		'description' => __( 'An optional widget area for your site footer', 'mytheme' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Footer Area Three', 'mytheme' ),
		'id' => 'sidebar-5',
		'description' => __( 'An optional widget area for your site footer', 'mytheme' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
 ...
 */
function mytheme_content_nav( $html_id ) {
	global $wp_query;
 ...
 *
 * Create your own mytheme_posted_on to override in a child theme
 *
 * @since Twenty Eleven 1.0
 */
function mytheme_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'mytheme' ),
 ...
 */
function mytheme_get_gallery_images() {
	$images = array();
