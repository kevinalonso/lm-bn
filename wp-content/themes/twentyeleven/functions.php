...
function extra_setup() {
	register_nav_menu ('primary mobile', __( 'Navigation Mobile', 'twentyeleven' ));
}
...
//function my_nav_wrap() {
  ...
  // the static link 
  /*$wrap .= '<ul class="my-static-ul">
  				<li class="my-static-link"><a id="menu-static-link" href="#">Menu</a></li>
  				<ul id="%1$s" class="%2$s"></ul>
  			</ul>';
